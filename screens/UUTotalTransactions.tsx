...
const UUTotalTransactions = () => {
  return (
    <View style={styles.uUTotalTransactions}>
      ...
      />
      <Text style={styles.totalTransactionsText}>Total Transactions</Text>
      <Image
...
export default UUTotalTransactions;
